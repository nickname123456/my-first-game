...
from models.behavior_tree_model import (
    BT_FAILURE,
    BT_RUNNING,
    BT_SUCCESS,
    ActionNode,
...
from models.pathfinding_model import GridCell, astar_path


REST_FATIGUE_THRESHOLD = 75.0 # если усталость выше этого значения, сотрудник будет искать отдых, если ниже - будет продолжать работать
REST_EXIT_THRESHOLD = 35.0 # если усталость ниже этого значения, сотрудник выйдет из состояния отдыха
...
WALK_FATIGUE_PER_SECOND = 1.0 # количество усталости, которое сотрудник набирает в секунду при ходьбе
